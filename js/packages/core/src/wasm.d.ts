...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_2236: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_6293: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_2243: (a: number, b: number, c: number) => void;
